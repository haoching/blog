...
export function validateFrontmatter(raw: string): { data: Record<string, unknown>; content: string; slug: string; title: string } {
  ...
  return { data, content: parsed.content, slug: slug as string, title };
}
